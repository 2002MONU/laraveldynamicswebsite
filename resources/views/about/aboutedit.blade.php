                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Update About section</h4>
                        </div>
                        @if(Session('success'))
                    ...
                    <div class="card-body">
                        <form action="{{url('admin/editab',$aboutpage->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label class="form-label" for="email">Heading Name <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="heading" id="email1" value="{{$aboutpage->heading}}">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{asset('website-images/aboutpage/'.$aboutpage->image)}}">
                                <img src="{{asset('website-images/aboutpage/'.$aboutpage->image)}}" style="width:100px;height:100px;"></a><br>
                                <span class="text-danger">(PNG,JPG,JPEG,SIZE-1MB,Min_Dim-1400X1000,Max_Dim-1900X1300)</span>
