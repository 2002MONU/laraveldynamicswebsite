        ...
        <div class="row">
            <div class="col-sm-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{url('admin/aboutpageditab',$about->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="heading" id="email1" value="{{$about->heading}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="paragraph1" id="email1" value="{{$about->paragraph1}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="paragraph2" id="email1" value="{{$about->paragraph2}}">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{asset('website-images/aboutpage/'.$about->image)}}">
                                <img src="{{asset('website-images/aboutpage/'.$about->image)}}" style="width:100px;height:100px;"></a><br>
