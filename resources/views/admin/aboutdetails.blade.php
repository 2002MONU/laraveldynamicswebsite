                  ...
                  <table id="basic-table" class="table table-striped table-shadow mb-0" role="grid">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>{{$abouts->paragraph1}}</td>
                           <td>{{$abouts->paragraph2}}</td>
                           <td><a href="{{asset('website-images/aboutimages/'.$abouts->image)}}"><img src="{{asset('website-images/aboutimages/'.$abouts->image)}}" style="width:100px;height:100px;"></a></td>
                           <td>{{$abouts->created_at}}</td>
                           <td>{{$abouts->updated_at}}</td>
                           <td>
                            <a href="{{'aboutupdate/'.$abouts->id}}" class="btn btn-info"><i class="fa-solid fa-pen-to-square"></i></a>
