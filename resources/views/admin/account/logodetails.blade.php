                  ...
                  <table id="basic-table" class="table table-striped table-shadow mb-0" role="grid">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td> {{$logo->email}}</td>
                           <td>{{$logo->phone}}</td>
                           <td><a href="{{asset('website-images/logoimage/'.$logo->logo)}}"><img src="{{asset('website-images/logoimage/'.$logo->logo)}}" style="width:150px;height:50px;"></a></td>
                           <td>{{$logo->created_at}}</td>
                           <td>{{$logo->updated_at}}</td>
                           <td>
                            <a href="{{'admin/logochange/'.$logo->id}}" class="btn btn-info"><i class="fa-solid fa-pen-to-square"></i></a>
