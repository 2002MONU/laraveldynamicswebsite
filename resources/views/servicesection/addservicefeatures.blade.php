                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{url('addservice')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="form-label" for="email">Point 2</label>
                            ...
                            <div class="form-group">
                                <label class="form-label" for="email">Point 3 </label>
                            ...
                            <div class="form-group">
                                <label class="form-label" for="email">Point 4 </label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="email1" name="link" >
                                @if($errors->has('link'))
