         ...
         <div class="card">
            <div class="card-header d-flex justify-content-between border-0 m-3">
               <div class="header-title ">
                  <h4 class="card-title">Blog Details Details  </h4>
               </div>
                     @if(Session('success'))
               ...
               <div class="table-responsive">
                  ...
                  <table id="basic-table" class="table table-striped table-shadow mb-0" role="grid">
                     ...
                     <tbody>                        
                        <tr>
                           <td>{{$blogpage->id}}</td>
                           <td>{{$blogpage->heading}}</td>
                            <td><a href="{{asset('website-images/blogpage/'.$blogpage->image)}}">
                                <img src="{{asset('website-images/blogpage/'.$blogpage->image)}}" style="width:100px;height:100px;"></a></td>
                           <td>{{$blogpage->created_at}}</td>
                           <td>{{$blogpage->updated_at}}</td>
                           <td>
                            <a href="{{'editblog/'.$blogpage->id}}" class="btn btn-info"><i class="fa-solid fa-pen-to-square"></i></a>
